...
/**
 * This resolver is called when {@link c0rnell.flexer.query.agent.ConditionalQueryInstrumentationAgent} is used.
...
public final class ConditionalQueryRewriterResolver {
    ...
    public ConditionalQueryRewriter resolve(QueryMethod queryMethod) {
        try {
            var methodField = QueryMethod.class.getDeclaredField("method");
